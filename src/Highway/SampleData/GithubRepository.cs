    ...
    public class GithubSampleRepository : IRepository
    {
        ...
        public Collaborator GetCollaborator(string user)
        {
            return new Collaborator()
            {
                ...
                new Repository() { Name = "NSubstitute" , ImageUri = new Uri(_baseUrl, "SampleData/Images/MediumGray.png") },
                new Repository() { Name = "LastThursday" , ImageUri = new Uri(_baseUrl, "SampleData/Images/MediumGray.png") },
                new Repository() { Name = "Castle.Core" , ImageUri = new Uri(_baseUrl, "SampleData/Images/MediumGray.png") },
                new Repository() { Name = "IOCComparison" , ImageUri = new Uri(_baseUrl, "SampleData/Images/MediumGray.png") },
                new Repository() { Name = "NAppUpdate" , ImageUri = new Uri(_baseUrl, "SampleData/Images/MediumGray.png") },
